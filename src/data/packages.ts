...
export const mombasaPackages = [
  ...
  },
  {
    ...
    inclusions: [
      ...
      "Return Transfers",
      "Return Economy SGR Tickets",
      "Daily breakfast (KES 31,049 per night with fabulous breakfast)",
      "10% off food/drink + parking + high-speed internet included",
      "Beach and pool access with waterfall feature",
      "Kids playground",
      "Spa services available"
    ],
    exclusions: ["All Not Mentioned in the Inclusions", "Lunch and dinner (upgrade to Half Board KES 33,375, Full Board or All-Inclusive KES 35,235-39,150)", "Water sports", "Premium beverages"],
